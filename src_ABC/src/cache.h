...
{  
    unsigned long long previous_time_access;
...
{
    CacheLine cacheline[MAX_WAYS_PER_CACHE_SET];
}CacheSet;
...
typedef struct Cache
{
    ...
    unsigned long long number_of_sets;
    unsigned long long number_of_ways;
    unsigned long long replacement_policy;
    CacheSet *cacheset;
    // for tracking writebacks
